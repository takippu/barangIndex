export const loginData = {
    ...
    header: {
        title: "Welcome back",
        subtitle: "Sign in to track local market prices together."
    },
    form: {
        email: {
            label: "Email Address",
